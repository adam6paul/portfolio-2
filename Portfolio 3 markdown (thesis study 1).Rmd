...
model_1 <-   '  #Class Belonging direct effects
                class_belong_comp4 ~ a*class_disclose_comp2 + gender_nonbinary + gender_male_dummy +
                race_asian + race_black + race_hispanic + race_multiracial + class_know_prior +
                know_prior_group
                
                class_belong_comp4 ~ b*group_disclose_comp2
                
                #School Belonging direct effects
                school_belong_comp4 ~ c*class_disclose_comp2 + gender_nonbinary + gender_male_dummy +
                race_asian + race_black + race_hispanic + race_multiracial + class_know_prior +
                know_prior_group
